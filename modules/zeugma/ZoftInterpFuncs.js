...
{ //
  ...
  static ASYMP_AB (t)  { return this.JANUSIZE (t, this.ASYMP_A, this.ASYMP_B); }
  static ASYMP (t)  { return this.ASYMP_B (t); }
  ...
  static QUADRATIC (t)  { return this.QUADRATIC_B (t); }

  static CUBIC_A (t)  { return (t * t * t); }
  static CUBIC_B (t)  { return (t * (3.0 - (t * (3.0 - t)))); }
  static CUBIC_AB (t)  { return this.JANUSIZE (t, this.CUBIC_A, this.CUBIC_B); }
  static CUBIC (t)  { return this.CUBIC_B (t); }
}
