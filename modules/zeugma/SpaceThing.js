...
export class SpaceThing extends LimnyThing {
  ...
  AssuredGrapplerPile() {
    if (this.gr_pile == null) this.gr_pile = new GrapplerPile();
    return this.gr_pile;
  }

  AppendGrappler(g) {
    if (g != null) this.AssuredGrapplerPile().AppendGrappler(g);
    return this;
  }

  PrependGrappler(g) {
    if (g != null) this.AssuredGrapplerPile().PrependGrappler(g);
    return this;
  }
  ...
  DependCumuMatsFrom(cm_above) {
    if (this.gr_pile == null) return (this.cumu_mats = cm_above);
    if (this.cumu_mats == null) this.cumu_mats = new CumuMats(false);
    if (cm_above == null)
      this.cumu_mats.FreshenVia(
        this.gr_pile.pnt_mat,
      ...
      this.cumu_mats.FreshenVia(
        this.gr_pile.pnt_mat.Mul(cm_above.pmat),
  ...
  Inhale(ratch, thyme) {
    if (this.gr_pile != null) this.gr_pile.Inhale(ratch, thyme);
    return 0;
  }
}
