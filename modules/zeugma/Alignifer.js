...
export class Alignifer extends SpaceThing {
  ...
  SetScale(vec_or_sclr) {
    ...
    else this.z_sca.Set(vec_or_sclr);
    return this;
  }
  ...
  AlignOverUp(ov, up) {
    ...
    if (cgr != null) cgr.SetViaNormalizedBasisVectors(o, u, n);
  ...
  AlignToOther(afer) {
    if (afer != null) this.AlignOverUp(afer.CurOver(), afer.CurUp());
    return this;
  }

  AlignToMaes(maes) {
    if (maes != null) this.AlignOverUp(maes.Over(), maes.Up());
  }
  //
}
