...
export class TrGrappler extends Grappler {
  ...
  constructor(tr_vect_or_zoft) {
    super();
    if (tr_vect_or_zoft == undefined) this.trans = Zoft.NewWith(Vect.zerov);
    else this.trans = Zoft.NewWith(tr_vect_or_zoft);
