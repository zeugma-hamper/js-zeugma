...
export class ViveWandEventSynth extends Zeubject {
  ...
  InterpretRawWandishWithMaesGeom(
    _pntr_nm,
    _bbits,
    _crsdct,
    _p,
  ...
  InterpretRawWandishWithMaesArray(pntr_nm, bbits, crsdct, p, a, o, maes_src) {
    ...
    if (maes_src != null) {
      const mah = PlatonicMaes.ClosestAmong(maes_src.Maeses(), p, a, true);
  ...
  InterpretRawWandish(pntr_nm, bbits, crsdct, pnt, aim, ovr) {
    return this.InterpretRawWandishWithMaesGeom(
      pntr_nm,
      bbits,
      crsdct,
      pnt,
