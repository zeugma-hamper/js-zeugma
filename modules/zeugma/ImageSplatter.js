...
export class ImageSplatter extends Alignifer {
  ...
  SetBackgroundColor(bc) {
    if (bc === this.back_iro) return this;
    if (this.back_iro == null || bc == null) this.back_iro = bc;
    else this.back_iro.Set(bc);
    return this;
  }
  ...
  SetBorderColor(bc) {
    if (bc === this.brdr_iro) return this;
    if (this.brdr_iro == null || bc == null) this.brdr_iro = bc;
    else this.brdr_iro.Set(bc);
    return this;
  }
  ...
  DrawSelf(ratch, cm, adjc, bonus) {
    ...
    if (this.back_iro != null) {
      ...
      if (adjc != null) bc = bc.Mul(adjc);
      ctx.fillStyle = bc.AsCSSString();
      ctx.fillRect(x, y, w, h);
    }

    if (this.immy != null) ctx.drawImage(this.immy, x, y, w, h);
