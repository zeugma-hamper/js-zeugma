...
export const RecursiveLimner = (supcls) =>
  class extends supcls {
    //
    RecursivelyDraw(zeub, ratch, thyme, cm_above, adjc_above, bonus) {
      if (zeub == null) return this;

      let cm = cm_above;
      let adjc = adjc_above;
      if (zeub.OughtToInhale(ratch)) zeub.Inhale(ratch, thyme);
