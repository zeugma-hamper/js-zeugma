...
export class ZESpatialCaressBaseEvent  extends ZESpatialEvent
{ //
  constructor (pr)
    { super (pr);
      this.crs_id = -1;
  ...
  EventIlk ()
    { return "ZESpatialCaressBaseEvent"; }
  ...
  CaressTrajectoryID ()
    { return this.crs_trj_id; }
  SetCaressTrajectoryID (ctid)
    { this.crs_trj_id = ctid;  return this; }
  ...
  ProfferAsQuaffTo (zbj)
    { return (zbj ?. ZESpatialCaressBase ?. (this))  ??  0; }
}


// just in the nick of time, faux-interface:
ZESpatialCaressBaseEvent.Phage = (supah) => class extends supah
{ ZESpatialCaressBase (e)  // arg's an event
